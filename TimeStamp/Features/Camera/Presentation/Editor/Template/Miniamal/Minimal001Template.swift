...
struct Minimal001Template: View, TemplateViewProtocol {
...
#Preview {
    VStack {
        ZStack {
            ...
            Minimal001Template(displayDate: Date(), hasLogo: true)
        }
        .frame(width: 300, height: 300)
        .aspectRatio(1, contentMode: .fit)
        ...
        ZStack {
            ...
            Minimal001Template(displayDate: Date(), hasLogo: false)
        }
        .frame(width: 300, height: 300)
        .aspectRatio(1, contentMode: .fit)
    }
