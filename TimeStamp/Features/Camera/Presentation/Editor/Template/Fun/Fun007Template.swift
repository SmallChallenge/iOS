...
struct Fun007Template: View, TemplateViewProtocol {
...
#Preview {
    VStack{
        ZStack {
            ...
            Fun007Template(displayDate: Date(), hasLogo: true)
        }
        .frame(width: 300, height: 300)
        .aspectRatio(1, contentMode: .fit)
        ...
        ZStack {
            ...
            Fun007Template(displayDate: Date(), hasLogo: false)
        }
        .frame(width: 300, height: 300)
        .aspectRatio(1, contentMode: .fit)
    }
