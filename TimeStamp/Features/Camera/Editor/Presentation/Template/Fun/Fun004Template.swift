...
struct Fun004Template: View, TemplateViewProtocol {
...
#Preview {
    VStack {
        ZStack {
            Image("sampleImage")
                .resizable()
            Fun004Template(displayDate: Date(), hasLogo: true)
        }
        ...
        ZStack {
            Image("sampleImage")
                .resizable()
            Fun004Template(displayDate: Date(), hasLogo: false)
        }
        .aspectRatio(1, contentMode: .fit)
    }
}
