...
struct Fun008Template: View, TemplateViewProtocol {
...
#Preview {
    VStack {
        ZStack {
            ...
            Fun008Template(displayDate: Date(), hasLogo: true)
        }
        ...
        ZStack {
            Image("sampleImage")
                .resizable()
            Fun008Template(displayDate: Date(), hasLogo: false)
        }
        .aspectRatio(1, contentMode: .fit)
    }
}
