...
struct Fun003Template: View, TemplateViewProtocol {
...
#Preview {
    VStack {
        ZStack {
            Image("sampleImage")
                .resizable()
            Fun003Template(displayDate: Date(), hasLogo: true)
        }
        ...
        ZStack {
            Image("sampleImage")
                .resizable()
            Fun003Template(displayDate: Date(), hasLogo: false)
        }
        .aspectRatio(1, contentMode: .fit)
    }
}
