...
struct Fun009Template: View, TemplateViewProtocol {
...
#Preview {
    VStack {
        ZStack {
            ...
            Fun009Template(displayDate: Date(), hasLogo: true)
        }
        ...
        ZStack {
            Image("sampleImage")
                .resizable()
            Fun009Template(displayDate: Date(), hasLogo: false)
        }
        .aspectRatio(1, contentMode: .fit)
    }
}
